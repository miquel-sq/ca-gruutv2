...
VOICED_PHONEMES=["ə","a","e","ɛ","i","o","ɔ","u","b","d","ɡ","ʎ","m","n","ɲ","ŋ","l","r","ɾ","z","ʒ","dʒ","β","ð","ɣ","w","j","v"]
UNVOICED_PHONEMES=["p", "t", "k", "f", "s", "ʃ", "ts", "tʃ"]
DEVOICING={
    "b": "p",
    "d": "t",
    "ɡ": "k",
    "ʒ": "ʃ",
    "ʤ": "tʃ",
    "v": "f",  # Including for completeness, even though "v" is not native to Catalan.
    "z": "s"
}
VOICING={
    "P": "b",
    ...
    "ʃ": "ʒ",
    "tʃ": "dʒ",
    "f": "v",  # Including for completeness, even though "v" is not native to Catalan.
    "s": "z"
}
