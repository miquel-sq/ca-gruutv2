...
class Transcripcio:
    ...
    def identify_lang(self, lang, nodes: typing.List[typing.Union[WordNode, BreakWordNode, BreakNode, PunctuationWordNode]]) -> str:
    ...
    def stress_tonic(self) -> str:
        ...
        E_OBERTA = ["el","ert","erd","erg","erm","ern","erc","erb","erp", \
                    "ela","erta","erda","erga","erma","erna","erca","erba","erpa"\
                    "els","erts","erds","ergs","erms","erns","ercs","erbs","erps", \
                    "eles","ertes","erdes","ergues","ermes","ernes","erques","erbes","erpes"]

        E_TANCADA = ["er","era","ers","eres","ell","ella","ells","elles","ent","eix","ed","eça","eces","ea","ees","ença","ences","em","ema","eixen","eixo","eixes","eixa"\
                     "ens","ena","enes","entra","essa","enta","entes","ents","enc","enca","encs","enques","eig","eja","eigs","ejes","et","eta","ets","etes"] 
        ...
        O_TANCADA = ["ora","ores","osa","oses","oni","onis","onin","ono","ona","ones","osa","oses","osos","orra","orres","onya","onyes","oma","omes","onze","oixa",]
    ...
    for node in nodes:
        ...
        if isinstance(node, WordNode):
            ...
            if count == 2:
                ...
                if lang in ["ca","ca-ce","ca-ba"] and node.text[-4:]!="ment":
